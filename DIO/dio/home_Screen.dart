import 'package:depi/dio/add_EditScreen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> fetchItems() async {
    final newItems = await ServicesHelperDio.getItems();
    setState(() {
      items = newItems;
    });
  }
  ...
  Future<void> updateItem(Item item) async {
    await ServicesHelperDio.updateItem(item, context);
    fetchItems();
    setState(() {});
  }

  Future<void> addItem(Item item) async {
    await ServicesHelperDio.addItem(item, context);
    fetchItems();
    setState(() {});
  }

  Future<void> deleteItem(Item item) async {
    await ServicesHelperDio.deleteItem(item.id! , context);
    fetchItems();
    setState(() {});
  }
